        ...
        <div className="w-5/6 px-10 md:px-16 lg:px-24 pb-10 grid mx-auto main-grid">
            <div className='art-container'>
                <div className='flex justify-between mt-5'>
                    ...
                    <div className='pj-art-top-right text-right'>
                        <div className="font-bold text-xl">
                            Creation XX/XX/XX
                        </div>
                        <div className='inline-grid justify-items-end'>
                            <button className="text-black bg-yellow-400 rounded-xl text-xl px-6 py-1 mb-4 mt-5" type="button">Website</button>
                            <button className="text-black bg-yellow-400 rounded-xl text-xl px-6 py-1 mb-4 mt-5" type="button">WhitePaper</button>
                            <button className="text-black bg-yellow-400 rounded-xl text-xl px-6 py-1 mb-4 mt-5" type="button">Social Networks</button>
                        </div>
                    </div>
                </div>
                <div className='art-body'>
                    {
                        moreArt && 
                        <div className='art-content border border-yellow-400 rounded-3xl p-7'>
                    ...
                    <div className='art-bottom-btn flex justify-around'>
                        <div>
                            {
                                !moreArt && 
                                <button className="text-black bg-yellow-400 rounded-xl text-xl px-6 py-1 mb-4 mt-5 mx-2" 
                                        type="button"
                                        onClick={ () => setMoreArt(true) }>See more</button>
                            }
                            <button className="text-black bg-yellow-400 rounded-xl text-xl px-6 py-1 mb-4 mt-5 mx-2" type="button">Download the form</button>
                        </div>
                    </div>
                </div>
            </div>
